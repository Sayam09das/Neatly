...
export const adminReviewCopy = {
  ...
  confirmDeleteDescription:
    "Reviews are not permanently deleted. Use Hide review to remove a review from public view.",
  confirmDeleteTitle: "Deletion is not available",
  confirmHideAction: "Hide",
  confirmHideDescription:
    "The review will be hidden from the public site. The record is kept.",
  confirmHideTitle: "Hide this review?",
  hideError: "Unable to hide review.",
