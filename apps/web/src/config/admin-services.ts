...
export const adminServiceCopy = {
  ...
  nameLabel: "Name",
  thumbnailFileHint: "JPEG, PNG, or WebP. Maximum 5MB.",
  thumbnailFileLabel: "Upload thumbnail",
  thumbnailLinkHint: "Or paste a public HTTPS image URL.",
  thumbnailLinkLabel: "Thumbnail URL",
  thumbnailPreviewLabel: "Thumbnail preview",
  saveLabel: "Save",
